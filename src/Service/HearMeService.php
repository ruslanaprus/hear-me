...
class HearMeService {
   ...
   */
  protected function getFieldTargetIds(array $fieldValues): array {
    $targetIds = [];
   ...
   */
  protected function allMediaIdsAreHearMeGenerated(array $mediaIds): bool {
    if (!$mediaIds) {
      return FALSE;
    }
   ...
   */
  protected function isHearMeGeneratedMedia(Media $media): bool {
